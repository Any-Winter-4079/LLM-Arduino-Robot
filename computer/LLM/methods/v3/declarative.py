...
def run_declarative(question, exemplars, cpp=False, iteration=0):
    """
    Run the Declarative method for equation-based mathematical problem solving.
    
    Constructs a template-based prompt, runs inference, extracts equations,
    and solves them symbolically to obtain the final answer.
    ...
    Returns:
        Tuple of (full prompt, detailed reasoning with equations, extracted answer)
    """
